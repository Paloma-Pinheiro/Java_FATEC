...
public class Modularização_25 
{
    public static void main(String[] args) 
{
    	/*As variáveis são preenchidas no módulo principal são verificadas para ver se os valores se encaixam nos limites de horas e minutos,
    	se não se encaixar, as variáveis são recebidas novamente*/
        ...
        JOptionPane.showMessageDialog(null, "Duração do jogo: " + Função(HoraInicio, MinutoInicio, HoraTermino, MinutoTermino));
}
    	//Módulo que calcula quanto tempo a partida durou
        static String Função(int HI, int MI, int HT, int MT) {
        	int IniciosMinutos = HI * 60 + MI;
        	int TerminosMinutos = HT * 60 + MT;
