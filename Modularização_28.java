...
public class Modularização_28
{
   public static void main ( String args [ ] )
   {
       ...
       JOptionPane.showMessageDialog(null, Função(Preco, Media));
   } 
   //Módulo que calcula o novo preço do produto
   static String Função(double Preco, double Media) 
   {    
       double PrecoNovo;
       if (Preco < 30 && Media < 500) 
       {
           PrecoNovo = Preco * 1.10;
           return "Novo preço - Ajuste de +10%:\nR$" + PrecoNovo;
       }
       else if (Media >= 500 || Media < 100 && Preco >= 30 || Preco < 80)
       {
           PrecoNovo = Preco * 1.15;
           return "Novo preço - Ajuste de +15%:\nR$" + PrecoNovo;
       }
       else if (Media >= 1000 && Preco >= 80)
       {
           PrecoNovo = Preco * 0.95;
           return "Novo preço - Ajuste de -5%:\nR$" + PrecoNovo;
       }
       else {
           PrecoNovo = Preco;
           return "O preço continuará igual:\nR$" + PrecoNovo;
       }
